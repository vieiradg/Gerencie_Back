...
def test_register(user_setup_teardown, name, email_input, password, cpf_input, status_code_esperado, mensagem_esperada):
    dados = {
        "name": name,
        "email": email_input,
        "password": password,
    ...
    assert status_code_esperado == response.status_code, (
